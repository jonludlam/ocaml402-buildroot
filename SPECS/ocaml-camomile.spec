...
%{?scl:%scl_package ocaml-camomile}
...
Name:           %{?scl_prefix}ocaml-camomile
Version:        0.8.5
Release:        2%{?dist}
...
BuildRequires:  %{?scl_prefix}ocaml >= 3.12.1-12
...
%changelog
* Mon Dec 8 2014 Jon Ludlam <jonathan.ludlam@citrix.com> - 0.8.5-2
- SCLify
